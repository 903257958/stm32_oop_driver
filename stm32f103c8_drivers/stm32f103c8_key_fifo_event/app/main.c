...
key_dev_t  key1  = {.config = {1, TIM2, GPIOB, GPIO_Pin_12, GPIO_LEVEL_LOW, 0, 2000, 100}};
key_dev_t  key2  = {.config = {2, TIM2, GPIOA, GPIO_Pin_8, GPIO_LEVEL_LOW, 200, 2000, 100}};
key_dev_t  key3  = {.config = {3, TIM2, GPIOB, GPIO_Pin_5, GPIO_LEVEL_LOW, 200, 2000, 100}};
