...
#include <stdlib.h>
	...
	#include "stm32f10x.h"
	typedef GPIO_TypeDef*	mpu6050_gpio_port_t;
	typedef uint32_t		mpu6050_gpio_pin_t;
...
typedef struct {
	mpu6050_gpio_port_t scl_port;	// SCL端口
	mpu6050_gpio_pin_t scl_pin;		// SCL引脚
	mpu6050_gpio_port_t sda_port;	// SDA端口
	mpu6050_gpio_pin_t sda_pin;		// SDA引脚
} mpu6050_config_t;
