...
/* 汉字字模数据声明 */
extern const chinese_cell_12_t lcd_cf12x12[];
extern const chinese_cell_16_t lcd_cf16x16[];
extern const chinese_cell_24_t lcd_cf24x24[];
extern const chinese_cell_32_t lcd_cf32x32[];
