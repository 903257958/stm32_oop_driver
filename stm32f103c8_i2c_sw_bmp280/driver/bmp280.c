...
/* 函数声明 */
static int8_t __bmp280_settings(BMP280Dev_t *dev, BMP280Setting_t *setting);
static int8_t __bmp280_get_id(BMP280Dev_t *dev, uint8_t *id);
static int8_t __bmp280_get_raw_data(BMP280Dev_t *dev, int32_t *pressure_raw, int32_t *temperature_raw);
static int8_t __bmp280_temperature_compensate(BMP280Dev_t *dev, int32_t *temperature_raw);
static int8_t __bmp280_pressure_compensate(BMP280Dev_t *dev, int32_t *pressure_raw);
static int8_t __bmp280_get_data(BMP280Dev_t *dev);
static int8_t __bmp280_deinit(BMP280Dev_t *dev);
 ...
 ******************************************************************************/
int8_t bmp280_init(BMP280Dev_t *dev)
{
    if (!dev)
		return -1;
