...
#include <stdlib.h>
	...
	typedef GPIO_TypeDef*	sr04_gpio_port_t;
	typedef uint32_t		sr04_gpio_pin_t;
...
typedef struct {
	...
	sr04_gpio_port_t trig_port;	// Trig端口
	sr04_gpio_pin_t trig_pin;	// Trig引脚
	sr04_gpio_port_t echo_port;	// Echo端口
	sr04_gpio_pin_t echo_pin;	// Echo引脚
} sr04_config_t;
