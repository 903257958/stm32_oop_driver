...
/* ESP8266串口设备 */
static uint8_t uart_esp8266_tx_buf[256];
static uint8_t uart_esp8266_rx_buf[2048];
...
int8_t esp8266_init(esp8266_dev_t *dev)
{
    ...
    uart_esp8266.config.tx_buf = uart_esp8266_tx_buf;
    uart_esp8266.config.rx_buf = uart_esp8266_rx_buf;
    uart_esp8266.config.tx_buf_size = sizeof(uart_esp8266_tx_buf);
    uart_esp8266.config.rx_buf_size = sizeof(uart_esp8266_rx_buf);
    uart_esp8266.config.rx_single_max = 1024;
...
static int8_t __esp8266_send_cmd(esp8266_dev_t *dev, char *cmd, char *res, char *recv_data)
{
	...
	/* 清理旧数据 */
    __esp8266_clear(&uart_esp8266.rx_cb);

    flag = __esp8266_cmd_recv_check(&uart_esp8266.rx_cb, res, recv_data);
